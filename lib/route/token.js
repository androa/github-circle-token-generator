...
const verifyToken = async () => {
  ...
  logger.debug("Testing newly generated application token.");
  ...
  logger.debug("Application token was successfully accepted by GitHub.");
...
const injectToken = async ({ owner, project }) => {
  ...
  logger.debug(`Installing token for ${owner}/${project}`);
